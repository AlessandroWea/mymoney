...
<h1 class="text-center">Requests for you as amigo</h1>
      ...
      <a href="#" id="c" class="amigo-card card w-100 m-1">
         <div class="car d-flex">
            ...
            <div class="card-body">
               ...
               <div class="btns">
                  <button type="button" id="btnAccept" data-id="<?=$row['id']?>" data-type='accept' class="btn btn-sm btn-danger">Accept</button>
               </div>
            </div>
         </div> 
      </a>
...
window.onload = () => {
   ...
   amigosContainer.addEventListener('click', (event) => {
      if(event.target.dataset.type == 'accept'){
         ...
         {
             request('POST', '/amigos/accept', data,
               function(){ 
                  if (this.status != 200) { 
